...
begin
   ...
   grant_access_to_user('FLIGHT_OPERATION_MANAGER', 'SELECT, INSERT, UPDATE', 'FLIGHT_SCHEDULE');
   grant_access_to_user('FLIGHT_OPERATION_MANAGER', 'SELECT, INSERT, UPDATE', 'ROUTES');
   grant_access_to_user('FLIGHT_OPERATION_MANAGER', 'SELECT', 'EMPLOYEE');
   grant_access_to_user('FLIGHT_OPERATION_MANAGER', 'SELECT, INSERT, UPDATE', 'CREW_ASSIGNMENT');
   ...
   grant_access_to_user('INVENTORY_MANAGER', 'SELECT, INSERT, UPDATE', 'INVENTORY');
   grant_access_to_user('INVENTORY_MANAGER', 'SELECT, INSERT, UPDATE', 'INVENTORY_ORDER');
   ...
   grant_access_to_user('CREW_MANAGER', 'SELECT', 'ROUTES');
